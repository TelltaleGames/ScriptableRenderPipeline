Shader "HDRenderPipeline/Water"
{
    Properties
    {
        ...
        _MurkDensity("MurkDensity", Float) = 1.0
        _SoftDepth("SoftDepth", Float) = 0.1
        ...
        _NormalMap2Vec("Normal Map Scrolling (x-z + speed)", Vector) = (-1,0,0,1)
        ...
        _TangentFlowMap("TangentFlowMap", 2D) = "bump" {}
        _TangentFlowSpeed("TangentFlowSpeed", Float) = 0.0
    ...
    #include "../../Material/Water/WaterProperties.hlsl"
    ...
    CustomEditor "Experimental.Rendering.HDPipeline.WaterGUI"
}
