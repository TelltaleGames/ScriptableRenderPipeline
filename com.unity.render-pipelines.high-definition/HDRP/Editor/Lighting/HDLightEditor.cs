    ...
    sealed partial class HDLightEditor : LightEditor
    {
        ...
        void DrawNPRLightProfile()
        {
            ...
            else
            {
                ...
                profile.IntensityCurve = EditorGUILayout.CurveField( CoreEditorUtils.GetContent( "NPR Intensity" ),
                    profile.IntensityCurve,
                    Color.blue,
                    new Rect( 0.0f, 0.0f, 1.0f, 1.0f ) );

                profile.OpacityCurve = EditorGUILayout.CurveField( CoreEditorUtils.GetContent( "NPR Opacity" ),
                    profile.OpacityCurve,
                    Color.blue,
                    new Rect( 0.0f, 0.0f, 1.0f, 1.0f ) );

                profile.SaturationCurve = EditorGUILayout.CurveField( CoreEditorUtils.GetContent( "NPR Saturation" ),
