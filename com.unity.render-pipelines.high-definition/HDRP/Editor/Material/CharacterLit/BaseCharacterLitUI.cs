...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    public abstract class BaseCharacterLitGUI : BaseUnlitGUI
    {
        ...
        static public void SetupBaseLitKeywords(Material material)
        {
            ...
            // Projection Decals hardcoded off for character materials
            CoreUtils.SetKeyword(material, "_DISABLE_DBUFFER", true);
