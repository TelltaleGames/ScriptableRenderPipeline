...
{
    public class CharacterLitGUI : BaseCharacterLitGUI
    {
        protected static class Styles
        {
            ...
            // Decals
            public static string decalLabelText = "Decals";
            public static GUIContent enableDecalsText = new GUIContent("Enable Decals", "");
            public static GUIContent UVDecalMappingText = new GUIContent("Decal UV mapping", "");
            public static GUIContent decalChannelText = new GUIContent("Decal Channel (RGBA)", "Individual masks for turning on/off decal maps.  Always uses UV0.");
            public static GUIContent decalColorText = new GUIContent("Decal Color", "Tint to apply to decal areas");
            public static GUIContent decalColorMapText = new GUIContent("Decal Color Map (RGBA)", "Decal texture map w/ Alpha");
            public static GUIContent decalNormalMapText = new GUIContent("Decal Normal Map", "Decal Normal Map - overrides underlying normal");
            public static GUIContent decalNormalScaleText = new GUIContent("Decal Normal Scale", "Decal Normal Intensity");
            public static GUIContent decalMaskMapText = new GUIContent("Decal Mask Map - M(R), AO(G), D(B), S(A)", "Decal Mask Map");
            public static GUIContent decalSmoothnessRemapText = new GUIContent("Decal Smoothness Remapping", "Smoothness remapping");
            public static GUIContent decalAORemapText = new GUIContent("Decal AO Remapping", "Ambient Occlusion remapping");
            public static GUIContent decalAIntensityText = new GUIContent("Decal A Intensity", "Slider for activating (R) channel of the Decal Mask");
            public static GUIContent decalBIntensityText = new GUIContent("Decal B Intensity", "Slider for activating (G) channel of the Decal Mask");
            public static GUIContent decalCIntensityText = new GUIContent("Decal C Intensity", "Slider for activating (B) channel of the Decal Mask");
            public static GUIContent decalDIntensityText = new GUIContent("Decal D Intensity", "Slider for activating (A) channel of the Decal Mask");
            public static GUIContent decalAsperityText = new GUIContent("Decal Asperity", "Value for asperity in enabled Decal areas");

            // Grime
            public static string grimeLabelText = "Grime";
            public static GUIContent enableGrimeText = new GUIContent("Enable Grime", "");
            public static GUIContent grimeMaskText = new GUIContent("Grime Mask (RGBA)", "Individual masks for turning on/off grime maps.  Always uses UV0.");
            public static GUIContent grimeAIntensityText = new GUIContent("Grime A Intensity", "Intensity of grime in R channel of grime mask");
            public static GUIContent grimeBIntensityText = new GUIContent("Grime B Intensity", "Intensity of grime in G channel of grime mask");
            public static GUIContent grimeCIntensityText = new GUIContent("Grime C Intensity", "Intensity of grime in B channel of grime mask");
            public static GUIContent grimeDIntensityText = new GUIContent("Grime D Intensity", "Intensity of grime in A channel of grime mask");
            public static GUIContent grimeAColorText = new GUIContent("Grime A Color", "Color of grime in R channel of grime mask");
            public static GUIContent grimeBColorText = new GUIContent("Grime B Color", "Color of grime in G channel of grime mask");
            public static GUIContent grimeCColorText = new GUIContent("Grime C Color", "Color of grime in B channel of grime mask");
            public static GUIContent grimeDColorText = new GUIContent("Grime D Color", "Color of grime in A channel of grime mask");
            public static GUIContent grimeASmoothnessText = new GUIContent("Grime A Smoothness", "Smoothness of grime in R channel of grime mask");
            public static GUIContent grimeBSmoothnessText = new GUIContent("Grime B Smoothness", "Smoothness of grime in G channel of grime mask");
            public static GUIContent grimeCSmoothnessText = new GUIContent("Grime C Smoothness", "Smoothness of grime in B channel of grime mask");
            public static GUIContent grimeDSmoothnessText = new GUIContent("Grime D Smoothness", "Smoothness of grime in A channel of grime mask");
        ...
        protected MaterialProperty decalChannelMap = null;
        protected const string kDecalChannelMap = "_DecalChannelMap";
        protected MaterialProperty UVDecals = null;
        protected const string kUVDecals = "_UVDecals";
        protected MaterialProperty UVMappingMaskDecals = null;
        protected const string kUVMappingMaskDecals = "_UVMappingMaskDecals";
        protected MaterialProperty decalColor = null;
        protected const string kDecalColor = "_DecalColor";
        protected MaterialProperty decalColorMap = null;
        protected const string kDecalColorMap = "_DecalColorMap";
        protected MaterialProperty decalNormalMap = null;
        protected const string kDecalNormalMap = "_DecalNormalMap";
        protected MaterialProperty decalNormalScale = null;
        protected const string kDecalNormalScale = "_DecalNormalScale";
        protected MaterialProperty decalMaskMap = null;
        protected const string kDecalMaskMap = "_DecalMaskMap";
        protected MaterialProperty decalSmoothnessRemapMin = null;
        protected const string kDecalSmoothnessRemapMin = "_DecalSmoothnessRemapMin";
        protected MaterialProperty decalSmoothnessRemapMax = null;
        protected const string kDecalSmoothnessRemapMax = "_DecalSmoothnessRemapMax";
        protected MaterialProperty decalAORemapMin = null;
        protected const string kDecalAORemapMin = "_DecalAORemapMin";
        protected MaterialProperty decalAORemapMax = null;
        protected const string kDecalAORemapMax = "_DecalAORemapMax";
        protected MaterialProperty decalAIntensity = null;
        protected const string kDecalAIntensity = "_DecalAIntensity";
        protected MaterialProperty decalBIntensity = null;
        protected const string kDecalBIntensity = "_DecalBIntensity";
        protected MaterialProperty decalCIntensity = null;
        protected const string kDecalCIntensity = "_DecalCIntensity";
        protected MaterialProperty decalDIntensity = null;
        protected const string kDecalDIntensity = "_DecalDIntensity";
        protected MaterialProperty decalAsperity = null;
        protected const string kDecalAsperity = "_DecalAsperity";


        protected MaterialProperty grimeEnable = null;
        protected const string kGrimeEnabled = "_EnableGrime";
        protected MaterialProperty grimeMaskMap = null;
        protected const string kGrimeMaskMap = "_GrimeMaskMap";
        protected MaterialProperty grimeAIntensity = null;
        protected const string kGrimeAIntensity = "_GrimeAIntensity";
        protected MaterialProperty grimeBIntensity = null;
        protected const string kGrimeBIntensity = "_GrimeBIntensity";
        protected MaterialProperty grimeCIntensity = null;
        protected const string kGrimeCIntensity = "_GrimeCIntensity";
        protected MaterialProperty grimeDIntensity = null;
        protected const string kGrimeDIntensity = "_GrimeDIntensity";
        protected MaterialProperty grimeAColor = null;
        protected const string kGrimeAColor = "_GrimeAColor";
        protected MaterialProperty grimeBColor = null;
        protected const string kGrimeBColor = "_GrimeBColor";
        protected MaterialProperty grimeCColor = null;
        protected const string kGrimeCColor = "_GrimeCColor";
        protected MaterialProperty grimeDColor = null;
        protected const string kGrimeDColor = "_GrimeDColor";
        protected MaterialProperty grimeASmoothness = null;
        protected const string kGrimeASmoothness = "_GrimeASmoothness";
        protected MaterialProperty grimeBSmoothness = null;
        protected const string kGrimeBSmoothness = "_GrimeBSmoothness";
        protected MaterialProperty grimeCSmoothness = null;
        protected const string kGrimeCSmoothness = "_GrimeCSmoothness";
        protected MaterialProperty grimeDSmoothness = null;
        protected const string kGrimeDSmoothness = "_GrimeDSmoothness";
        ...
        protected void FindMaterialDecalProperties(MaterialProperty[] props)
        {
            decalEnable = FindProperty(kDecalEnabled, props);
            decalChannelMap = FindProperty(kDecalChannelMap, props);
            UVDecals = FindProperty(kUVDecals, props);
            UVMappingMaskDecals = FindProperty(kUVMappingMaskDecals, props);
            decalColor = FindProperty(kDecalColor, props);
            decalColorMap = FindProperty(kDecalColorMap, props);
            decalNormalMap = FindProperty(kDecalNormalMap, props);
            decalNormalScale = FindProperty(kDecalNormalScale, props);
            decalMaskMap = FindProperty(kDecalMaskMap, props);
            ...
            decalAIntensity = FindProperty(kDecalAIntensity, props);
            decalBIntensity = FindProperty(kDecalBIntensity, props);
            decalCIntensity = FindProperty(kDecalCIntensity, props);
            decalDIntensity = FindProperty(kDecalDIntensity, props);
            decalAsperity = FindProperty(kDecalAsperity, props);
        }

        protected void FindMaterialGrimeProperties(MaterialProperty[] props)
        {
            grimeEnable = FindProperty(kGrimeEnabled, props);
            grimeMaskMap = FindProperty(kGrimeMaskMap, props);
            grimeAIntensity = FindProperty(kGrimeAIntensity, props);
            grimeBIntensity = FindProperty(kGrimeBIntensity, props);
            grimeCIntensity = FindProperty(kGrimeCIntensity, props);
            grimeDIntensity = FindProperty(kGrimeDIntensity, props);
            grimeAColor = FindProperty(kGrimeAColor, props);
            grimeBColor = FindProperty(kGrimeBColor, props);
            grimeCColor = FindProperty(kGrimeCColor, props);
            grimeDColor = FindProperty(kGrimeDColor, props);
            grimeASmoothness = FindProperty(kGrimeASmoothness, props);
            grimeBSmoothness = FindProperty(kGrimeBSmoothness, props);
            grimeCSmoothness = FindProperty(kGrimeCSmoothness, props);
        ...
        protected void DoDecalGUI(Material material)
        {
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(Styles.decalLabelText, EditorStyles.boldLabel);
            EditorGUI.indentLevel++;

            m_MaterialEditor.ShaderProperty(decalEnable, Styles.enableDecalsText);

            if (decalEnable.floatValue > 0.0f)
            {
                //decalChannelMap
                m_MaterialEditor.TexturePropertySingleLine(Styles.decalChannelText, decalChannelMap);

                //decalColorMap + decalColor
                m_MaterialEditor.TexturePropertySingleLine(Styles.decalColorText, decalColorMap, decalColor);
                // Decal UV Mapping
                if (material.GetTexture(kDecalColorMap))
                {
                    EditorGUI.indentLevel++;
                    m_MaterialEditor.ShaderProperty(UVDecals, Styles.UVDecalMappingText);
                    EditorGUILayout.Space();
                    UVBaseMapping uvDecalMapping = (UVBaseMapping)UVDecals.floatValue;

                    float X, Y, Z, W;
                    X = (uvDecalMapping == UVBaseMapping.UV0) ? 1.0f : 0.0f;
                    Y = (uvDecalMapping == UVBaseMapping.UV1) ? 1.0f : 0.0f;
                    Z = (uvDecalMapping == UVBaseMapping.UV2) ? 1.0f : 0.0f;
                    W = (uvDecalMapping == UVBaseMapping.UV3) ? 1.0f : 0.0f;

                    UVMappingMaskDecals.colorValue = new Color(X, Y, Z, W);

                    //m_MaterialEditor.TextureScaleOffsetProperty(decalColorMap);
                    EditorGUI.indentLevel--;
                }

                //decalNormalMap + decalNormalScale
                m_MaterialEditor.TexturePropertySingleLine(Styles.decalNormalMapText, decalNormalMap, decalNormalScale);
                //decalMaskMap
                m_MaterialEditor.TexturePropertySingleLine(Styles.decalMaskMapText, decalMaskMap);

                //decal intensity sliders
                m_MaterialEditor.ShaderProperty(decalAIntensity, Styles.decalAIntensityText);
                m_MaterialEditor.ShaderProperty(decalBIntensity, Styles.decalBIntensityText);
                m_MaterialEditor.ShaderProperty(decalCIntensity, Styles.decalCIntensityText);
                m_MaterialEditor.ShaderProperty(decalDIntensity, Styles.decalDIntensityText);

                //decalSmoothnessRemap
                float decalSmoothMin = decalSmoothnessRemapMin.floatValue;
                float decalSmoothMax = decalSmoothnessRemapMax.floatValue;
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.MinMaxSlider(Styles.decalSmoothnessRemapText, ref decalSmoothMin, ref decalSmoothMax, 0.0f, 1.0f);
                if (EditorGUI.EndChangeCheck())
                {
                    decalSmoothnessRemapMin.floatValue = decalSmoothMin;
                    decalSmoothnessRemapMax.floatValue = decalSmoothMax;
                }

                //decalAORemap
                float decalAOMin = decalAORemapMin.floatValue;
                float decalAOMax = decalAORemapMax.floatValue;
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.MinMaxSlider(Styles.decalAORemapText, ref decalAOMin, ref decalAOMax, 0.0f, 1.0f);
                if (EditorGUI.EndChangeCheck())
                {
                    decalAORemapMin.floatValue = decalAOMin;
                    decalAORemapMax.floatValue = decalAOMax;
                }

                // Decal Asperity
                m_MaterialEditor.ShaderProperty(decalAsperity, Styles.decalAsperityText);
            }
        ...
        protected void DoGrimeGUI(Material material)
        {
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(Styles.grimeLabelText, EditorStyles.boldLabel);
            EditorGUI.indentLevel++;

            m_MaterialEditor.ShaderProperty(grimeEnable, Styles.enableGrimeText);



            if (grimeEnable.floatValue > 0.0f)
            {

                // grimeMaskMap
                m_MaterialEditor.TexturePropertySingleLine(Styles.grimeMaskText, grimeMaskMap);

                EditorGUILayout.Space();
                m_MaterialEditor.ShaderProperty(grimeAIntensity, Styles.grimeAIntensityText);
                m_MaterialEditor.ShaderProperty(grimeAColor, Styles.grimeAColorText);
                m_MaterialEditor.ShaderProperty(grimeASmoothness, Styles.grimeASmoothnessText);

                EditorGUILayout.Space();
                m_MaterialEditor.ShaderProperty(grimeBIntensity, Styles.grimeBIntensityText);
                m_MaterialEditor.ShaderProperty(grimeBColor, Styles.grimeBColorText);
                m_MaterialEditor.ShaderProperty(grimeBSmoothness, Styles.grimeBSmoothnessText);

                EditorGUILayout.Space();
                m_MaterialEditor.ShaderProperty(grimeCIntensity, Styles.grimeCIntensityText);
                m_MaterialEditor.ShaderProperty(grimeCColor, Styles.grimeCColorText);
                m_MaterialEditor.ShaderProperty(grimeCSmoothness, Styles.grimeCSmoothnessText);

                EditorGUILayout.Space();
                m_MaterialEditor.ShaderProperty(grimeDIntensity, Styles.grimeDIntensityText);
                m_MaterialEditor.ShaderProperty(grimeDColor, Styles.grimeDColorText);
                m_MaterialEditor.ShaderProperty(grimeDSmoothness, Styles.grimeDSmoothnessText);
