...
{
    class WaterGUI : BaseWaterGUI
    {
        protected static class Styles
        {
            public static string InputsText = "Inputs";

            public static GUIContent baseColorText = new GUIContent("Murk Color", "Albedo (RGB) and Opacity (A)");
            public static GUIContent murkDensityText = new GUIContent("Murk Density", "Exponential control of murk opacity");
            public static GUIContent softDepthText = new GUIContent("Soft Depth", "Fades diff & spec near intersections with other geo");
            ...
            public static GUIContent tangentFlowMapText = new GUIContent("Tangent Flow Map", "Tangent Flow Map (BC7/BC5/DXT5(nm))");
        ...
        protected MaterialProperty murkDensity = null;
        protected const string kMurkDensity = "_MurkDensity";
        protected MaterialProperty softDepth = null;
        protected const string kSoftDepth = "_SoftDepth";
        ...
        protected const string kNormalScale2 = "_NormalScale2";
        protected MaterialProperty normalFrequency = null;
        protected const string kNormalFrequency = "_NormalFrequency";
        protected MaterialProperty normalMap1 = null;
        protected const string kNormalMap1 = "_NormalMap1";
        protected MaterialProperty normalMap1Vec = null;
        protected const string kNormalMap1Vec = "_NormalMap1Vec";
        protected MaterialProperty normalMap2 = null;
        ...
        protected MaterialProperty tangentFlowMap = null;
        protected const string kTangentFlowMap = "_TangentFlowMap";
        protected MaterialProperty tangentFlowSpeed = null;
        protected const string kTangentFlowSpeed = "_TangentFlowSpeed";
        ...
        protected override void FindMaterialProperties(MaterialProperty[] props)
        {
            ...
            normalMap1Vec = FindProperty(kNormalMap1Vec, props);
            normalMap2Vec = FindProperty(kNormalMap2Vec, props);
            normalMap1 = FindProperty(kNormalMap1, props);
            normalMap2 = FindProperty(kNormalMap2, props);
            ...
            tangentFlowSpeed = FindProperty(kTangentFlowSpeed, props);
...
*/
        protected void ShaderFlowInputGUI()
        {
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Tangent Flow Map", EditorStyles.boldLabel);
            EditorGUI.indentLevel++;
            m_MaterialEditor.TexturePropertySingleLine(Styles.tangentFlowMapText, tangentFlowMap, tangentFlowSpeed);
            EditorGUI.indentLevel--;
        }
        ...
        protected void DoLayerGUI(Material material, int layerIndex, bool isLayeredLit, bool showHeightMap)
        {
            ...
            m_MaterialEditor.ShaderProperty(murkDensity, Styles.murkDensityText);
            m_MaterialEditor.ShaderProperty(softDepth, Styles.softDepthText);
            ...
            */
            ...
            m_MaterialEditor.ShaderProperty(normalMap1Vec, Styles.normalMapScrollText);
        ...
        static public void SetupMaterialKeywordsAndPass(Material material)
        {
            ...
            CoreUtils.SetKeyword(material, "_NORMALMAP", material.GetTexture(kNormalMap1) || material.GetTexture(kNormalMap2) || material.GetTexture(kDetailMap));
            CoreUtils.SetKeyword(material, "_TANGENTMAP", material.GetTexture(kTangentFlowMap));
