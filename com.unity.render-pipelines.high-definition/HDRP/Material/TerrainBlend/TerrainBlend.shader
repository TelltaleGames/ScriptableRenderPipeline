Shader "HDRenderPipeline/TerrainBlend"
{
    Properties
    {
        ...
        _Smoothness0("Smoothness0", Range(0.0, 1.0)) = 0.0
        _Smoothness1("Smoothness1", Range(0.0, 1.0)) = 0.0
        _Smoothness2("Smoothness2", Range(0.0, 1.0)) = 0.0
        _Smoothness3("Smoothness3", Range(0.0, 1.0)) = 0.0
