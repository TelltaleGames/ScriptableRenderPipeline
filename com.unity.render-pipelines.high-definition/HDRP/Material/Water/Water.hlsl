...
BSDFData ConvertSurfaceDataToBSDFData(uint2 positionSS, SurfaceData surfaceData)
{
    ...
    ConvertAnisotropyToClampRoughness(bsdfData.perceptualRoughness, /*bsdfData.anisotropy*/0.0, bsdfData.roughnessT, bsdfData.roughnessB);
...
uint DecodeFromGBuffer(uint2 positionSS, uint tileFeatureFlags, out BSDFData bsdfData, out float3 bakeDiffuseLighting)
{
    ...
    bool pixelHasAnisotropy   = false;//materialFeatureId == GBUFFER_LIT_ANISOTROPIC;
    ...
    bool pixelHasMetallic = false; //HasFeatureFlag(pixelFeatureFlags, MATERIALFEATUREFLAGS_LIT_ANISOTROPY | MATERIALFEATUREFLAGS_LIT_IRIDESCENCE);
