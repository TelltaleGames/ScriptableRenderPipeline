...
{
    public class CompileTimeBooleanSlotControlView : VisualElement
    {
        CompileTimeBooleanMaterialSlot m_Slot;

        public CompileTimeBooleanSlotControlView(CompileTimeBooleanMaterialSlot slot)
        {
